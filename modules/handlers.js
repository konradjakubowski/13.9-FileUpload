...
w exports.welcome zczytujemy plik start.html za pomocą fs. Parametr to html. Dodajemy Response Headers i wyświetlamy zawartość pliku html przez .write(html)

form.parse (request, function(error, fields, files)
^ dzięki temu moduł formidable odpowiednio formuuje zapytanie

fs.renameSync(files.upload.path, "test.png");
^ zmiana nazwy uploadowanego pliku na test.png i zapis do start.html
